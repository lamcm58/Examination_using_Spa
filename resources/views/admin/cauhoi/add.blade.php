...
@section('content')
    <div class="col-lg-7" style="padding-bottom:120px">
        <form action="{!! route('admin.cauhoi.add') !!}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="id_dethi" id="id_dethi">
                    ...
                    @foreach($dethi as $de)
                    <option value="{!! $de['id_dethi'] !!}">{!! $de['ten_dethi'] !!}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                <label for="id_cauhoi">Mã Câu Hỏi</label>
                <input class="form-control" name="id_cauhoi" id="id_cauhoi" placeholder="Vui Lòng Điền Mã Câu Hỏi" required />
            </div>
            <div class="form-group">
                <label for="noi_dung">Nội Dung Câu Hỏi</label>
                <textarea name="noi_dung" id="noi_dung" class="form-control" style="height: 250px;"></textarea>
