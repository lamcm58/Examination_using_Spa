...
<head>
    ...
    <meta name="description" content="Quản lý bài thi">
    <meta name="author" content="Cao Minh Lâm">
    <title>Examination Using SPA</title>
    ...
    <script type="text/javascript" src="{{ url('admin/MathJax/MathJax.js') }}"></script>
</head>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <div class="navbar-brand">Examination Using SPA</div>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ url('admin/dashboard') }}"><i class="fa fa-dashboard fa-fw"></i> Trang chủ</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Môn thi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/monthi/list') }}">Danh sách môn thi</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/monthi/add') }}">Thêm môn thi</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-cube fa-fw"></i> Đề thi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/dethi/list') }}">Danh sách đề thi</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/dethi/add') }}">Thêm đề thi</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-users fa-fw"></i> Câu hỏi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ url('admin/cauhoi/list') }}">Danh sách câu hỏi</a>
                                </li>
                                <li>
                                    <a href="{{ url('admin/cauhoi/add') }}">Thêm câu hỏi</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
    ...
    <script src="{{ url('admin/js/myscrypt.js') }}"></script>
</body>
